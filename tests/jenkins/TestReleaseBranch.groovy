...
class TestReleaseBranch extends BuildPipelineTest {
    ...
    void setUp() {
        ...
        binding.setVariable('MANIFEST_URL', manifestUrl)
    ...
    public void testBranchCreation() {
        super.testPipeline('jenkins/release/release-branch.jenkinsfile',
                'tests/jenkins/jenkinsjob-regression-files/release-tag/release-branch-buildmanifest.jenkinsfile')
    }
    ...
    public void testBranchExistence() {
        ...
        runScript('jenkins/release/release-branch.jenkinsfile')
    ...
    public void testInputManifest() {
        binding.setVariable('MANIFEST_URL', "2.0.0/opensearch-2.0.0.yml")
        ...
        super.testPipeline('jenkins/release/release-branch.jenkinsfile',
                'tests/jenkins/jenkinsjob-regression-files/release-tag/release-branch-inputmanifest.jenkinsfile')
    }

    @Test
    public void testVerifyParameters() {
        binding.setVariable('MANIFEST_URL', "")
        binding.setVariable('TARGET_BRANCH', "")
        runScript('jenkins/release/release-branch.jenkinsfile')
        assertThat(getCommandExecutions('error', ''), hasItem('Required parameters are missing. Please provide the mandatory arguments MANIFEST_URL, SOURCE_BRANCH and TARGET_BRANCH'))
    }
